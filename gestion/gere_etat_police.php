...
if (isset($_SESSION['pseudo']) && isset($_SESSION['passe'])) 
 {  
     require('./variables/etat_police.php');
     $chemin='./variables/etat_police.php' ;
     require_once ('./variables/var_ferme_la_police.php');

     echo'<center>
         <div class="cadre">';
            if ($metlapolice=='O') { echo '<br><br><br><span class="text_aide">'.$Tvoi_police.'</span><br><br>'; } 
            else { echo '<br><br><br><span class="text_aide">'.$Tvoi_pas_police.'</span><br><br>';}
          echo'
          <br><br>'.$Tmodif_champ.'
    ...
    if (!$fic_user) { echo $Tacces_non.$chemin ;  exit; }
        ...
        if ($gerechamp=='N') { 
           fwrite ($fic_user,$lapolice_ferme_non) ;
           echo'<script language="javascript">;alert("Les choix de polices sont invisibles sur votre livre !");</script>';
           echo '<meta http-equiv="refresh" content="0;URL=admin.php?page=etat_polis">'; 
           exit;
        } 
        else { 
             fwrite($fic_user,$lapolice_ferme_oui) ; 
             fclose($fic_user);
             echo'<script language="javascript">;alert("Les choix de polices sont visibles sur votre livre !");</script>';
             echo '<meta http-equiv="refresh" content="0;URL=admin.php?page=etat_polis">'; 
