...
if (isset($_SESSION['pseudo']) && isset($_SESSION['passe'])) 
 {  
     require('./variables/etat_note.php'); 
     $chemin='./variables/etat_note.php' ; 
     require_once ('./variables/var_ferme_metlanote.php');

     echo'<center>
         <div class="cadre">';
            if ($metlanote=='O') { echo '<br><br><br><span class="text_aide">'.$Tvoi_note.'</span><br><br>'; } 
            else { echo '<br><br><br><span class="text_aide">'.$Tvoi_pas_note.'</span><br><br>';}
          echo'
          <br><br>'.$Tmodif_champ.'
    ...
    if (!$fic_user) { echo $Tacces_non.$chemin ;  exit; }
        ...
        if ($gerechamp=='N') { 
           fwrite ($fic_user,$metlanote_ferme_non) ;
           echo'<script language="javascript">;alert("La note est invisible sur votre livre !");</script>';
           echo '<meta http-equiv="refresh" content="0;URL=admin.php?page=etat_note">'; 
           exit;
        } 
        else { 
             fwrite($fic_user,$metlanote_ferme_oui) ; 
             fclose($fic_user);
             echo'<script language="javascript">;alert("La note est visible sur votre livre !");</script>';
             echo '<meta http-equiv="refresh" content="0;URL=admin.php?page=etat_note">'; 
